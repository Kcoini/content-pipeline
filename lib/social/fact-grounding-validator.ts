...
// OPS-04-FIX1(섹션 21, FP-E): "3. 실패하신 분은..." 같은 번호 목록에서
// "3."이 숫자를 포함한 문장 끝처럼 보여 별도 "문장"(숫자만 남은
// "3.")으로 잘못 분리되던 문제를 고친다 — 직전 두 글자가 "숫자+마침표"
// (목록 번호)이면 그 지점에서는 분리하지 않는다. 작고 명백한 수정이라
// 이번 Phase에서 바로 반영한다(섹션 21의 "명백함/아주 작음/회귀
// fixture 가능" 조건을 만족).
