...
import { buildArticleBlogUrl, buildMetricsDeepLink, buildRewriteVersionDeepLink, buildArticleOverviewUrl } from "@/lib/navigation/article-deep-links";
...
export default async function ArticleBlogPage({
  ...
  const { article, posts } = await buildArticleBlogPageData(id, { includeRewriteVersions });
